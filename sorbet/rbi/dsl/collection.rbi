...
class Collection
  ...
  module GeneratedAssociationMethods
    ...
    def collection_magic_card_ids; end

    sig { params(ids: T::Array[T.untyped]).returns(T::Array[T.untyped]) }
    def collection_magic_card_ids=(ids); end

    sig { returns(::CollectionMagicCard::PrivateCollectionProxy) }
    def collection_magic_cards; end

    sig { params(value: T::Enumerable[::CollectionMagicCard]).void }
    def collection_magic_cards=(value); end
